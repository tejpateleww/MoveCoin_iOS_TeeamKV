...
class profileDataDataModel : NSObject, NSCoding{
    ...
    init(fromJson json: JSON!){
        ...
        unreadMsgCount = json["unread_msg_count"].stringValue
    ...
    func toDictionary() -> [String:Any]
    {
        ...
        if unreadMsgCount != nil{
            dictionary["unread_msg_count"] = unreadMsgCount
        }
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        unreadMsgCount = aDecoder.decodeObject(forKey: "unread_msg_count") as? String
    ...
    func encode(with aCoder: NSCoder)
    {
        ...
        if unreadMsgCount != nil{
            aCoder.encode(unreadMsgCount, forKey: "unread_msg_count")
        }
        if weekStepsCount != nil{
